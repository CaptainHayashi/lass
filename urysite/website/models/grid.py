...
class GridBlock(Type):
    ...
    `GridBlockLayout` and `GridLayout` models are concerned with
    this.

    """
    width = models.IntegerField(
        help_text='The width of this block, in arbitrary units.'
    )
    height = models.IntegerField(
        help_text='The height of this block, in arbitrary units.'
    )
